    ...
    <BaseLayout pageTitle="How does Donategifts work?">
        ...
        <div className="items-center flex flex-wrap px-4">
          <div className="w-full md:w-5/12 mx-auto px-2 py-2">
            <div className="md:pr-12">
              <h3 className="text-3xl font-semibold text-white cool-font">
                Step 1
              </h3>
        ...
        <div className="w-full">
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              <h1 className="cool-font dg-color-blue text-4xl">
                Ready to donate gifts?
              </h1>
              <button className="mt-6 text-lg font-semibold quick-font dg-bg-blue text-white rounded-lg px-5 py-5 hover:bg-blue-500 focus:outline-none">
      ...
      <section id="partner" className="relative pt-4 w-full dg-bg-cream">
        ...
        <div className="items-center flex flex-wrap px-4">
          <div className="w-full md:w-5/12 mx-auto px-2 py-2">
            <div className="md:pr-12">
              <h3 className="text-3xl font-semibold dg-color-yel cool-font">
                Step 1
              </h3>
              <p className="mt-4 text-2xl quick-font dg-color-blue font-semibold">
